<%-- 
    ...
    Created on : 21 Mar, 2019, 11:47:48 AM
    Author     : aswin
--%>
...
<div class="main">
	<div class="contact">
		<div class="section group">				
            ...
            PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_staff where staffmem_id=?");
            ps.setString(1, a);
        ...
        <div>
            ...
            <span><input type="text" name="t3" value="<%=rs.getString(3)%>" readonly="true"></span>
        </div>
        <div>
        ...
        <%
            if(request.getParameter("b1")!=null)
            {
                ...
                PreparedStatement p=(PreparedStatement)db.cn.prepareStatement("update tb_staff set job=?, phone=? , addrs=? , email=? where staffmem_id=?");
