<%-- 
    Document   : BookByTitl
    Created on : 3 Apr, 2019, 12:11:13 PM
    Author     : aswin
--%>
				...
				<div class="table100 ver1 m-b-110">
					...
					<div class="table100-body js-pscroll">
							...
							<tbody>
                                                            <%
                                                                Dbcon db=new Dbcon();
                                                                 String at=(String)session.getAttribute("ww");
                                                                PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_book where title=?");
                                                                ps.setString(1, at);
