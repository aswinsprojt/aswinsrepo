<%-- 
    Document   : GetStaff
    Created on : 14 Mar, 2019, 1:01:53 PM
    Author     : aswin
--%>
...
<html>
    ...
    <body>
         <%
           Dbcon db=new Dbcon();
           PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("insert into tb_staff values(?,?,?,?,?,?,?,?,?)");
           String s1=request.getParameter("t1");
           String s2=request.getParameter("t2");
           String s3=request.getParameter("s1");
           String s4= request.getParameter("s2");
           ...
           PreparedStatement p=(PreparedStatement)db.cn.prepareStatement("update tb_id set staffmem_id=?");
           p.setInt(1, n);
           db.execution(p);
