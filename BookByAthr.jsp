<%-- 
    Document   : sample
    Created on : 3 Apr, 2019, 11:38:37 AM
    Author     : aswin
--%>
				...
				<div class="table100 ver1 m-b-110">
					...
					<div class="table100-body js-pscroll">
							...
							<tbody>
                                                            <%
                                                                Dbcon db=new Dbcon();
                                                                String at=(String)session.getAttribute("ss");
                                                                PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_book where author=?");
                                                                ps.setString(1, at);
