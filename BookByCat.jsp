<%-- 
    Document   : BookByCat
    Created on : 3 Apr, 2019, 12:11:27 PM
    Author     : aswin
--%>
				...
				<div class="table100 ver1 m-b-110">
					...
					<div class="table100-head">
									...
									<th class="cell100 column3">Author</th>	
                                                                        ...
                                                                        <th class="cell100 column7">Search</th>
								</tr>
							</thead>
						</table>
					</div>
					...
					<div class="table100-body js-pscroll">
							...
							<tbody>
                                                            <%
                                                                ...
                                                                PreparedStatement p=(PreparedStatement)db.cn.prepareStatement("select catid from tb_category where catgry=? and sub=?");
                                                                p.setString(1, a);
                                                                p.setString(2, b);
                                                                ...
                                                                PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_book where catid=?");
                                                                ps.setString(1, g);
								...
								<tr class="row100 body">
									...
									<td class="cell100 column3"><%=rs.getString(5)%></td>
                                                                        ...
                                                                        <td class="cell100 column7"><a href="SrchKwrd.jsp?d=<%=rs.getString(2)%>" target="_blank">Search</a></td>
								</tr>
                                                                 <%
                                                                }
                                                            %>
