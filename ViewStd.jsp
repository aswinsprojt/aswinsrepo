<%-- 
    Document   : RemoveStd
    Created on : 19 Mar, 2019, 12:56:31 PM
    Author     : aswin
--%>
			...
			<div class="wrap-table100">
				...
				<div class="table100 ver1 m-b-110">
					...
					<div class="table100-head">
									...
									<th class="cell100 column3">Department Id</th>	
                                                                        <th class="cell100 column3">Sem</th>
					...
					<div class="table100-body js-pscroll">
							...
							<tbody>
                                                            <%
                                                                Dbcon db=new Dbcon();
                                                                PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_student");
								...
								<tr class="row100 body">
									...
									<td class="cell100 column3"><%=rs.getString(3)%></td>
                                                                        ...
                                                                        <td class="cell100 column4"><a href="UpdateStd.jsp?d=<%=rs.getString(1)%>">Update</a></td>
                                                                        <td class="cell100 column5"><a href="RemoveStd.jsp?d=<%=rs.getString(1)%>">Remove</a></td>
								</tr>
                                                                 <%
                                                                }
                                                            %>
