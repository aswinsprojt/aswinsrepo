<%-- 
    ...
    Created on : 7 Mar, 2019, 2:27:40 PM
    Author     : aswin
--%>
				...
				<div class="table100 ver1 m-b-110">
					<div class="table100-head">
							...
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Category Id</th>
					...
					<div class="table100-body js-pscroll">
							...
							<tbody>
                                                            <%
                                                                Dbcon db=new Dbcon();
                                                                PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_category");
								...
								<tr class="row100 body">
									...
									<td class="cell100 column3"><%=rs.getString(3)%></td>
                                                                        <td class="cell100 column4"><a href="UpdateCat.jsp?d=<%=rs.getString(1)%>">Update</a></td>
                                                                        <td class="cell100 column5"><a href="RemoveCat.jsp?d=<%=rs.getString(1)%>">Remove</a></td>
								</tr>
                                                                 <%
                                                                }
                                                            %>
