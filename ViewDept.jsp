<%-- 
    Document   : RemoveDept
    Created on : 14 Mar, 2019, 2:29:45 PM
    Author     : aswin
--%>
				...
				<div class="table100 ver1 m-b-110">
					<div class="table100-head">
							...
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Department Id</th>
					...
					<div class="table100-body js-pscroll">
							...
							<tbody>
                                                            <%
                                                                Dbcon db=new Dbcon();
                                                                PreparedStatement ps=(PreparedStatement)db.cn.prepareStatement("select * from tb_dept");
								...
								<tr class="row100 body">
									...
									<td class="cell100 column3"><%=rs.getString(3)%></td>
                                                                        <td class="cell100 column4"><a href="UpdateDept.jsp?d=<%=rs.getString(1)%>">Update</a></td>
                                                                        <td class="cell100 column5"><a href="RemoveDept.jsp?d=<%=rs.getString(1)%>">Remove</a></td>
								</tr>
                                                                 <%
                                                                }
                                                            %>
